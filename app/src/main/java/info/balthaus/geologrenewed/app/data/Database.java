...
package info.balthaus.geologrenewed.app.data;
...
import info.balthaus.geologrenewed.app.R;
...
public class Database {
    ...
    public static Activity activityFromInt(int activity) {
        switch (activity) {
            ...
            case 2:
                return Activity.FOOT;
            case 3:
                return Activity.BICYCLE;
            case 4:
    ...
    public static class Profile implements BaseColumns {
        ...
        public class ActivitySettings {
            ...
            public ActivitySettings setActivityInterval(int activityInterval) {
                this.activityInterval = activityInterval;
                return this;
            }

            public ActivitySettings setLocationInterval(int locationInterval) {
                this.locationInterval = locationInterval;
                return this;
            }

            public ActivitySettings setAccuracy(Accuracy accuracy) {
        ...
        public int getReduceAccuracyDelay() {
            return reduceAccuracyDelay;
        }

        public ActivitySettings getUnknown() {
            return unknown;
        }

        public ActivitySettings getStill() {
            return still;
        }

        public ActivitySettings getFoot() {
            return foot;
        }

        public ActivitySettings getBicycle() {
            return bicycle;
        }

        public ActivitySettings getVehicle() {
            return vehicle;
        }
        ...
        public Profile setType(Type type) {
            this.type = type;
            return this;
        }
        ...
        public Profile setReduceAccuracyDelay(int reduceAccuracyDelay) {
            this.reduceAccuracyDelay = reduceAccuracyDelay;
            return this;
        }
    ...
    public static class Location implements BaseColumns {
        ...
        public boolean hasAccuracyDistance() {
            return hasAccuracyDistance;
        }
        ...
        public Accuracy getAccuracySetting() {
        ...
        public Location setLogId(long logid) {
            this.logid = logid;
            return this;
        }

        public Location setActivity(Activity activity) {
            this.activity = activity;
            return this;
        }

        public Location setConfidence(int confidence) {
            this.confidence = confidence;
            return this;
        }

        public Location setTime(long time) {
            this.time = time;
            return this;
        }
        ...
        public Location hasAltitude(boolean hasAltitude) {
            this.hasAltitude = hasAltitude;
            return this;
        }

        public Location setBearing(float bearing) {
            this.bearing = bearing;
            return this;
        }

        public Location hasBearing(boolean hasBearing) {
        ...
        public Location hasSpeed(boolean hasSpeed) {
            this.hasSpeed = hasSpeed;
            return this;
        }

        public Location setAccuracyDistance(float accuracyDistance) {
            this.accuracyDistance = accuracyDistance;
            return this;
        }

        public Location hasAccuracyDistance(boolean hasAccuracyDistance) {
            this.hasAccuracyDistance = hasAccuracyDistance;
            return this;
        }

        public Location setBattery(int battery) {
            this.battery = battery;
            return this;
        }

        public Location setAccuracySetting(Accuracy accuracySetting) {
            this.accuracySetting = accuracySetting;
            return this;
        }

        public Location isSegmentStart(boolean isSegmentStart) {
