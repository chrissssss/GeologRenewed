...
import info.balthaus.geologrenewed.app.Application;
...
import info.balthaus.geologrenewed.app.data.Database.Location;
...
public class Exporter {
    ...
    private String performExport(OnExportProgressListener callback, Cursor cursor) {
        ...
        switch (format) {
            case GPX:
                filename = Application.SDCARD_PATH + "/geolog.gpx";
                break;
            case KML:
                filename = Application.SDCARD_PATH + "/geolog.kml";
                break;
        }
        ...
        try {
            ...
            try {
                ...
                switch (format) {
                    case GPX:
                        writer = new GPXWriter(fos);
                        break;
                    case KML:
                        writer = new KMLWriter(fos);
                        break;
                }
