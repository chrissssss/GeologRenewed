...
package info.balthaus.geologrenewed.app.service;
...
import info.balthaus.geologrenewed.app.Debug;
import info.balthaus.geologrenewed.app.R;
import info.balthaus.geologrenewed.app.data.Database;
import info.balthaus.geologrenewed.app.data.Database.Accuracy;
import info.balthaus.geologrenewed.app.data.Database.Activity;
import info.balthaus.geologrenewed.app.data.Database.Profile.Type;
import info.balthaus.geologrenewed.app.ui.MainActivity;
import info.balthaus.geologrenewed.app.ui.SettingsFragment;
...
public class BackgroundService extends Service {
    ...
    private static String EXTRA_ALARM_CALLBACK = "info.balthaus.geologrenewed.app.EXTRA.ALARM_CALLBACK";
    ...
    private class ServiceThread extends Thread {
            ...
            if (wantedActivityInterval != lastActivityInterval) {
                ...
                if (wantedActivityInterval != 0) {
                    ...
                    ActivityRecognition.ActivityRecognitionApi.requestActivityUpdates(mGoogleApiClient,
                            wantedActivityInterval * 1000, activityIntent);
                }
        ...
        private ConnectionCallbacks activityConnectionCallbacks = new ConnectionCallbacks() {
            ...
            public void onConnectionSuspended(int i) {
                Debug.log("ActivityRecognitionClient connection suspended");
        ...
        private ConnectionCallbacks locationConnectionCallbacks = new ConnectionCallbacks() {
            ...
            public void onConnectionSuspended(int i) {
                //API changed
                Debug.log("LocationClient connection suspended");
