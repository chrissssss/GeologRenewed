...
public class ProfilesProvider extends ContentProvider {
    public static final String AUTHORITY = "info.balthaus.geologrenewed.app.profilesprovider";
    public static final String BASE_PATH = "profiles";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + BASE_PATH);

    private static final int PROFILES = 10;
    private static final int PROFILE = 20;

    private static final UriMatcher URIMatcher = new UriMatcher(UriMatcher.NO_MATCH);

    static {
        URIMatcher.addURI(AUTHORITY, BASE_PATH, PROFILES);
        URIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", PROFILE);
    }
